...
abstract class Visitor {
  ...
  protected function visitChildCall(Shell $shell, array $child, $func) {
    $mappings = array(
      ...
      'greater_than_equals' => 'GreaterThanEqualsVisitor',
      'greater_than' => 'GreaterThanVisitor',
      'if' => 'IfVisitor',
      'invocation' => 'InvocationVisitor',
      'key_values' => 'KeyValuesVisitor',
      'key_value' => 'KeyValueVisitor',
      'less_than_equals' => 'LessThanEqualsVisitor',
      'less_than' => 'LessThanVisitor',
      'minus' => 'MinusVisitor',
      'multiply' => 'MultiplyVisitor',
      'not_equals' => 'NotEqualsVisitor',
      'not' => 'NotVisitor',
